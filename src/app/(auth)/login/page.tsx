        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              ...
              disabled={loading}
              className="group w-full py-3.5 px-4 bg-white border-2 border-gray-300 text-gray-900 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-400 hover:shadow-lg transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-3 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-linear-to-r from-transparent via-gray-100 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
              
              <div className="relative flex items-center justify-center w-7 h-7 bg-white rounded-full shadow-sm border border-gray-200 group-hover:border-gray-300 transition-colors">
              ...
              <span className="relative text-gray-900 font-semibold group-hover:text-black transition-colors">
                Continuer avec Google
              </span>
              
              {loading && (
                <div className="absolute right-4 h-5 w-5 border-2 border-gray-400 border-t-transparent rounded-full animate-spin"></div>
              )}
            </button>
          </form>
