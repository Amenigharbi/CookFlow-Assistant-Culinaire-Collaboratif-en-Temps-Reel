        ...
        <div className="bg-white rounded-2xl shadow-xl border border-emerald-100 p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 w-full p-3.5 bg-white border-2 border-gray-800 text-gray-900 rounded-xl focus:ring-2 focus:ring-black focus:border-black transition-all placeholder:text-gray-500"
                />
              </div>
              {errors.fullName && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="pl-10 pr-10 w-full p-3.5 bg-white border-2 border-gray-800 text-gray-900 rounded-xl focus:ring-2 focus:ring-black focus:border-black transition-all placeholder:text-gray-500"
                />
                <button
                  type="button"
              ...
              <div className="mt-3 space-y-2">
                <div className="flex items-center gap-2">
                  <div className={`h-2 w-full rounded-full ${password?.length >= 6 ? 'bg-black' : 'bg-gray-200'}`}></div>
                  <span className="text-xs text-gray-500">6+ caractères</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className={`h-2 w-full rounded-full ${/[A-Z]/.test(password || '') ? 'bg-black' : 'bg-gray-200'}`}></div>
                  <span className="text-xs text-gray-500">1 majuscule</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className={`h-2 w-full rounded-full ${/[0-9]/.test(password || '') ? 'bg-black' : 'bg-gray-200'}`}></div>
            ...
            <button
              ...
              disabled={loading}
              className="group w-full py-3.5 px-4 bg-white border-2 border-gray-200 text-gray-800 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-3 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-linear-to-r from-transparent via-gray-50 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
              
              <div className="relative flex items-center justify-center w-6 h-6 bg-white rounded-full shadow-sm">
              ...
              <span className="relative text-gray-800 font-medium group-hover:text-gray-900 transition-colors">
                S&apos;inscrire avec Google
              </span>
              
              {loading && (
                <div className="ml-2 h-5 w-5 border-2 border-gray-400 border-t-transparent rounded-full animate-spin"></div>
              )}
            </button>
          </form>
